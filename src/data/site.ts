...
export const PHOTOS = {
    ...
    /**
     * A downtown street from the air. Deliberately not captioned with a city
     * name: the source photo came in unlabelled and guessing wrong is exactly
     * the failure this site's photo rules exist to prevent.
     */
    downtownAerial: {
        src: "/images/downtown-aerial.webp",
        alt: "Aerial view along a tree-lined downtown street in the Inland Empire, California",
    },
} as const;
...
export interface AreaDef {
    ...
    image?: string;
    /**
     * Shown over the hero when the photograph is regional rather than of this
     * specific city. A hero image on a page titled "Pomona" reads as Pomona
     * whatever the alt text says, so the cities without their own photograph
     * carry a visible credit naming where the picture was actually taken.
     */
    imageCredit?: string;
    imageAlt?: string;
    /**
